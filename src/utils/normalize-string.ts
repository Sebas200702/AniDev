 ...
 * and replacing spaces with hyphens. It's particularly useful for creating slugs or clean URL paths
 ...
 * 2. Replaces all whitespace characters with hyphens to create a URL-friendly format
 *
 ...
 * @returns {string} The normalized string with special characters removed and spaces replaced by hyphens
 *
 * @example
