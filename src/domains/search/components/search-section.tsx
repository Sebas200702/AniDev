...
import { AppliedFiltersComponent } from 'domains/search/components/filters/applied-filters'
import { useEffect, useRef, useState } from 'react'

import { FilterSection } from 'domains/search/components/filters/filter-section'
import { SearchHistoryModal } from 'domains/search/components/history/search-history-modal'
import { SearchResults } from 'domains/search/components/results/search-results'
import { SearchStats } from 'domains/search/components/search-stats'
import { SearchResultsErrorBoundary } from 'domains/shared/components/error-boundary'
