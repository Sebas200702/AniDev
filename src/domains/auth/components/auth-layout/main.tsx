import { Step1, Step2, Step3 } from '@auth/components/auth-steps/index'
...
export const Main = ({ isLoading, isSignUp, title }: Props) => {
  ...
  return (
    <section className="z-10 flex h-full w-full flex-col bg-Complementary/50 backdrop-blur-sm rounded-md items-center justify-center md:px-8 py-4">
      {steps[currentStep - 1] && (
        <>
