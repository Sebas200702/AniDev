...
import { NextIcon } from 'domains/shared/components/icons/next-icon'
import { PreviousIcon } from 'domains/shared/components/icons/previous-icon'
import { ResetIcon } from 'domains/shared/components/icons/reset-icon'
import { RotateLeftIcon } from 'domains/shared/components/icons/rotate-left-icon'
import { RotateRightIcon } from 'domains/shared/components/icons/rotate-right-icon'
import { ZoomInIcon } from 'domains/shared/components/icons/zoom-in-icon'
import { ZoomOutIcon } from 'domains/shared/components/icons/zoom-out-icon'
