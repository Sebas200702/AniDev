...
export const AnimeMusicItem = ({
  ...
  return (
    <article
      ...
      className={`anime-music-item link transition-all duration-200 ease-out ${isDragging ? 'z-50' : ''} group group border-enfasisColor group relative flex  w-full cursor-pointer flex-row items-start rounded-lg border-l-4 transition-all duration-300 ease-in-out  max-h-36 aspect-[100/30] md:gap-2 md:hover:translate-x-1`}
    >
      <div className="flex aspect-[100/30] max-h-36   w-full flex-row overflow-hidden rounded-lg ">
        <div className="absolute top-0 aspect-[100/30] max-h-36  left-0  w-full overflow-hidden rounded-lg">
          <img
          ...
          <div className="flex w-full flex-col items-start space-x-1 truncate text-pretty ease-in-out select-none md:flex-row">
            ...
            {song.artist_name && (
              <a
                ...
                className="text-sxx text-Primary-300 flex  flex-row items-end gap-1 truncate md:w-auto w-min"
              >
                By
