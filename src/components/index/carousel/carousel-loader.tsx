...
export const LoadingCarousel = () => (
  <div className="carousel-anime-banner relative h-[85vh] animate-pulse bg-zinc-900 md:h-[650px] xl:h-[900px]">
    <div className="relative flex h-[85vh] w-full flex-shrink-0 flex-col items-center md:h-[650px] md:flex-row xl:h-[900px]">
      <div className="z-10 mx-auto -mt-14 flex h-full w-full max-w-2xl flex-col items-center justify-center gap-4 p-6 text-white md:mr-16 md:ml-8 md:h-auto md:items-start md:justify-normal">
        ...
        <div className="flex w-full flex-row items-center justify-center gap-4 md:mt-2 md:justify-normal">
