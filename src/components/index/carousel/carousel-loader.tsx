...
export const LoadingCarousel = () => (
  <div className="carousel-anime-banner relative h-[85vh] md:h-[650px] animate-pulse bg-zinc-900 xl:h-[900px]">
    <div className="relative flex h-[85vh] w-full flex-shrink-0 md:h-[650px] flex-col items-center xl:h-[900px] md:flex-row">
      <div className="z-10 mx-auto -mt-14 flex h-full w-full max-w-2xl flex-col items-center justify-center gap-4 p-6 text-white md:mr-16 md:ml-8 md:h-auto md:items-start md:justify-normal">
        ...
        <div className="flex w-full flex-row items-center justify-center md:justify-normal gap-4 md:mt-2">
          <div className="h-12 w-34 animate-pulse rounded-lg bg-zinc-800 md:flex"></div>
          <div className="h-12 w-34 animate-pulse rounded-lg bg-zinc-800"></div>
        </div>
      </div>
    </div>
    <div className="absolute bottom-20 left-1/2 z-30 flex h-4 w-44 -translate-x-1/2 animate-pulse rounded-lg bg-zinc-800 md:bottom-16"></div>
  </div>
)
