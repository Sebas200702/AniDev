export const AnimeTopLoader = () => {
  return (
    <div className="relative px-4 md:px-20">
      <header className="flex w-full flex-row gap-4 items-center mb-10">
        <div className="bg-enfasisColor h-10 w-2 rounded-lg"></div>
        <div className="h-6 w-28 rounded-md bg-zinc-800 md:h-8 md:w-40"></div>
      </header>
      <div className="mx-auto grid xl:grid-cols-2 grid-cols-1 items-center justify-around gap-4 xl:gap-x-12">
        {Array(10)
          .fill(0)
          .map((_, i) => (
            <div
            ...
            >
              ...
              <div className="bg-Complementary w-full animate-pulse rounded-lg duration-300">
                <div className="aspect-[225/330] h-auto w-full max-w-20 md:max-w-32 animate-pulse rounded-lg bg-zinc-800"></div>
              </div>
            </div>
          ))}
      </div>
