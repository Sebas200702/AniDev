...
export const BannerInfo = ({
  ...
  return (
    <div
      className={`bg-Primary-950/50 absolute z-10 flex h-full w-full ${isMobile ? 'inset-0' : ''} flex-col items-center justify-between p-3 md:p-4 md:right-0 md:bottom-10 md:max-h-44 md:max-w-96 md:rounded-l-2xl md:pr-10 xl:max-h-60`}
    >
      <a
        href={`/${slug}_${mal_id}`}
