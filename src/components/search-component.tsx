...
export const SearchComponent = () => {
  ...
  const url = debouncedQuery
    ? `${baseUrl}/api/animes?search_query=${debouncedQuery}&limit_count=5&type=tv`
    : ''
  const {
    data: animes,
    loading,
  ...
  return (
    <section className='flex flex-col gap-4'>
      <input
        type='search'
        id='default-search'
        className='w-full max-w-3xl mx-auto p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500  '
