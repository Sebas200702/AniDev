...
export const AnimeCharacterCard = ({ character }: { character: Character }) => {
  return (
    <article className="group from-Primary-950/50 to-Primary-950/80 hover:border-enfasisColor/60 relative md:h-full aspect-[100/32] md:min-h-32 transform overflow-hidden rounded-xl border border-gray-100/20 bg-gradient-to-br backdrop-blur-sm transition-all duration-300 ease-in-out hover:-translate-y-1 md:h-28">
