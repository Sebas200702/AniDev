...
export const AnimeBanner = ({ id }: { id: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 z-10 mx-auto flex h-full w-full flex-col justify-between gap-4 bg-black/30 p-2 md:m-6 md:h-auto md:max-w-80 md:rounded-lg">
        <a
          href={`/${slug}_${mal_id}`}
