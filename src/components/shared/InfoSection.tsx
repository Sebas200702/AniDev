...
export const InfoSection = ({ title, children, ulClassName = '' }: Props) => {
  return (
    <section className="z-10 flex h-min border-Primary-800/30 from-Complementary  via-Primary-950 to-Complementary/95 border bg-gradient-to-br shadow-2xl w-full ease-in-out md:rounded-xl flex-col items-center justify-center row-span-2 transition-all duration-300 col-span-1">
