...
export const AnimeCharacterCard = ({ character }: { character: Character }) => {
  return (
    <article className="group from-Primary-950/50 to-Primary-950/80 hover:border-enfasisColor/60 relative h-20 transform overflow-hidden rounded-xl border border-gray-100/20 bg-gradient-to-br backdrop-blur-sm transition-all duration-300 ease-in-out hover:-translate-y-1 md:h-28">
