...
export const AnimeLoader = () => {
  return (
    <div className="">
      <div className="relative aspect-[1080/600] h-[65dvh]  w-full animate-pulse bg-zinc-800 duration-300">
      ...
      <div className="z-10 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-15 md:px-20 px-4 ">
